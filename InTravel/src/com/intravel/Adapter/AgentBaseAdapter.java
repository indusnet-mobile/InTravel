...
public class AgentBaseAdapter extends BaseAdapter {
	...
	public AgentBaseAdapter(Context mContexts,
			ArrayList<HotelDetails> arrayHotelListDetail, Boolean isCallFromFav) {
		this.context = mContexts;
		this.arrayHotelListDetail = arrayHotelListDetail;
		this.minfInflater = (LayoutInflater) mContexts.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			mHolder = (Holder_Agent) convertView.getTag();
		}
		if (isCallFromFav) {
		...
		if (mDetails != null) {
			...
			if (mDetails.getFavStatus() == 0) {
				...
				mHolder.imageFab.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						if (mAgentItemClickListner != null && Address != null) {
							mAgentItemClickListner.UpdateIsFavouriteOne(Address, 1, position);
						}
					}
				});
			} else {
				...
				mHolder.imageFab.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						if (mAgentItemClickListner != null && Address != null) {
							mAgentItemClickListner.UpdateIsFavouriteOne(Address, 0, position);
						}
	...
	public interface AgentItemClickListner {
	...
	public AgentItemClickListner mAgentItemClickListner;

	public AgentItemClickListner getmAgentItemClickListner() {
		return mAgentItemClickListner;
	}

	public void setmAgentItemClickListner(
			AgentItemClickListner mAgentItemClickListner) {
