...
public class SessionEvents {
    ...
    private static LinkedList<PostMessageListener> mPostListener=
    	new LinkedList<PostMessageListener>();
    ...
    public static void addPostMessageListener(PostMessageListener listener){
    	mPostListener.add(listener);
    }
    ...
    public static void onpostingFinish(){
    	for (PostMessageListener l : mPostListener) {
            l.onPostSuccessfyll();
        }
    }
    ...
    public static interface PostMessageListener{
    	public void onPostSuccessfyll();
    }
